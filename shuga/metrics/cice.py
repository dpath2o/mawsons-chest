    ...
    def _compute_requested_metrics(self, method: str, requested: set[str]) -> xr.Dataset:
        ...
        def get_or_compute(name: str, publish: bool = False) -> xr.DataArray | None:
            ...
            if name == "FIA" and fi_mask is not None:
                ...
                return remember(
                    name,
                    self.compute_strength_series(
                        aice, hi, ds["strength"], area, si_mask,
                        name="SIS",
                ...
                return remember(
                    name,
                    self.compute_volume_rate(
                        ds["dvidtt"], aice, area, si_mask,
                        name="SITVR",
                ...
                return remember(
                    name,
                    self.compute_area_rate(
                        ds["daidtt"], area, si_mask,
                        name="SITAR",
                ...
                return remember(
                    name,
                    self.compute_spatial_rate_year(
                        ds["dvidtt"], si_mask,
                        name="SITVR_YR",
