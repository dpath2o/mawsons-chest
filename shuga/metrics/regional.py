...
def spatial_dims(da: xr.DataArray, *, exclude: set[str] | None = None) -> list[str]:
    """
...
def region_mask(template: xr.DataArray, lon: xr.DataArray, lat: xr.DataArray, region_defs: dict) -> xr.DataArray:
    """
