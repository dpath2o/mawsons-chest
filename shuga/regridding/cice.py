...
def compute_tgrid_speed(
    ...
    *,
    ...
    if "Tc" in selection:
        ...
        velE_T, velN_T = c2t(
            ds[uvelE_var], ds[uvelN_var], ds[vvelE_var], ds[vvelN_var], target,
            wrap_x=wrap_x, combine=cgrid_combine, nan_to_zero=True,
        )
    ...
    if "Tx" in selection:
        if regridder is None:
            raise NotImplementedError(
                "Tx requested but no explicit B-grid->T-grid regridder was supplied. "
