...
"${MONTAGE[@]}" \
    ...
    "${OUT_DIR}/Aus_FIP-weighted-FI-thickness_and_LD-tau_no-slip-LFI_vs_Cs-high-ktens-high_2000-2005.png"
...
"${MONTAGE[@]}" \
    ...
    -tile 1x -geometry +0+30 -background white \
    "${OUT_DIR}/Aus_FIP-weighted-FI-thickness_and_LD-tau_2000-2005.png"

echo "Wrote:"
echo "  ${OUT_DIR}/Aus_FIP-weighted-FI-thickness_and_LD-tau_no-slip-LFI_vs_Cs-high-ktens-high_2000-2005.png"
echo "  ${OUT_DIR}/Aus_FIP-weighted-FI-thickness_and_LD-tau_form-comparison_2000-2005.png"
