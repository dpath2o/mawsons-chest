...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description = "Compute CMEMS FI/PI/SI metrics on the native grid.")
    p.add_argument("--root", default = "/g/data/gv90/da1339/SeaIce/CMEMS/0p083/daily")
...
def main() -> None:
    ...
    runner = CMEMSMetrics(root         = args.root,
                          ...
                          logger       = logger)
    outputs = runner.compute_metrics(args.method,
